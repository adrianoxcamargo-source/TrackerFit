...
export default function Metricas() {
  ...
  const startEdit = (metric: BodyMetric) => {
    ...
    setTimeout(() => document.getElementById("assessment-form")?.scrollIntoView({ behavior: "smooth", block: "start" }), 0);
  };
