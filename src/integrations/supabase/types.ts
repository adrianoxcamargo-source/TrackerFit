...
export type Database = {
  _analytics: {
    Tables: {
      ...
      log_events_532b4d93_688b_41b4_a5e2_6ab2023f9f49: {
        Row: {
          body: Json | null
      ...
      log_events_591e8591_ab52_4e21_ac23_cc990d398d8e: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_6f3f3ca0_cddb_435c_b751_8b3afc511dcf: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_a8330e5f_8b28_41d0_880e_b718a75b8325: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_b044592f_9520_4687_8da1_4d5f7413ac57: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_d120509c_6a4e_4bd3_ac22_b4d3a8d5a639: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_d5a372b0_8dfd_4dfa_a60e_1caa9c092526: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_db7e57ac_9109_4753_b609_ece6317b4d0d: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_dc9825d3_acc0_4c19_b951_1a18dd4285c9: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
  ...
  public: {
    Tables: {
      athlete_trainer_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "athlete_trainer_links_athlete_id_fkey"
            columns: ["athlete_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "athlete_trainer_links_trainer_id_fkey"
            columns: ["trainer_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      cardio_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "cardio_logs_athlete_id_fkey"
            columns: ["athlete_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      program_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "program_settings_athlete_id_fkey"
            columns: ["athlete_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      workout_exercises: {
        ...
        Relationships: [
          {
            foreignKeyName: "workout_exercises_athlete_id_fkey"
            columns: ["athlete_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
